...
<h3 class="   text-xl  lg:text-[26px] text-white sm:text-2xl sm:font-medium mt-3">Keep your goods safe by using three tier packaging specially designed to keep products safe and containers moisture free. </h3>
</div>

</div></swiper-slide
    ><swiper-slide><div class=" carousel-cell h-[90vh] md:px-8 md:h-screen main-banner2 flex flex-col prevent justify-center bg3 ">
  <h3 class=" mx-10 text-xl  lg:text-[26px] text-[#DCC4A4] sm:text-2xl sm:font-medium ">As reported by Sandia National Laboratories in a paper, corrosion due to water accounts for <span class="text-yellow-300 tag text-5xl">20%</span> of electronics failures. Moisture intrusion has been known to cause product fires and even aircraft failures. </h3>
<div class="mx-10 mt-6"><h1 class="text-5xl  font-bold  md:text-7xl   text-white  sm:text-6xl">Prevent.</h1></div>
<div class="mx-10 md:mr-16  pt-6 ">

<h3 class="   text-xl  lg:text-[26px] text-white sm:text-2xl sm:font-medium mt-3">Prevent damage of electronics and other equipments by using carefully crafted product-specific desiccants.</h3>
</div>

</div></swiper-slide>

<swiper-slide><div class=" carousel-cell h-[90vh] md:px-8 md:h-screen main-banner2 flex flex-col bg4  justify-center  ">
  <h3 class=" mx-10 text-xl  lg:text-[26px] text-[#DCC4A4] sm:text-2xl sm:font-medium ">Relative Humidity is an indicator of the amount of moisture present in the air. Ideally, RH above <span class="text-yellow-300 tag text-5xl">45%</span> can lead to bacterial growth. Higher RH levels can also lead to mold growth and general product deterioration.  </h3>
<div class="mx-10 mt-6"><h1 class="text-5xl  font-bold  md:text-7xl   text-white  sm:text-6xl">Preserve.</h1></div>
<div class="mx-10 md:mr-16  pt-6 ">

<h3 class="   text-xl  lg:text-[26px] text-neutral-400 sm:text-2xl sm:font-medium mt-3">Increase the shelf life of your products by using efficent and longer lasting adsorbents with high absorption capacity. </h3>
</div>
