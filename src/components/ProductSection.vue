<template>
  <div id='products'  class=" py-20 px-10 lg:mx-20  text-center grid justify-center items-center">
  <div>
  <h2 class="text-3xl md:text-4xl mt-3 font-bold border-b-2 pb-3 text-center inline-block  w-fit px-3 border-gray-400 border-solid">Matter dictates Moisture</h2></div>
